...
const lost_and_found = () => {
    const [formData, setFormData] = useState({
      ...
      const handleAdd = () => {
        if (!formData.name || !formData.program || !formData.branch || !formData.phoneNumber || !formData.details || !formData.place || !formData.password) {
      ...
      return (
        ...
        <div className="lost-found">
          ...
          <div className="form-container">
            ...
            <input type="text" id="program" name="program" value={formData.program} onChange={handleChange} />
            ...
            <button id="add-detail-btn" onClick={handleAdd}>Add</button>
          </div>
            ...
            <tbody>
              {lostAndFoundData.map((item, index) => (
                <tr key={index}>
                  ...
                  {/* <td>{item.password}</td> */}
                  <td>
                    <button id="add-detail-btn" onClick={() => { setDeleteIndex(index); }}>Delete</button>
                  </td>
                </tr>
              ))}
            </tbody>
